...
```html
<!-- fig-1: 单图 | --w:width --h:height --x:horizontal --y:vertical --gap:spacing -->
...
> ```html
> <!-- fig-RxC: R行×C列 | --w:width --h:height --x:horizontal --y:vertical --gap:spacing -->
> ```
